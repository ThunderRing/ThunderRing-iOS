...
var chatData : [MessageData] = [
    ...
    MessageData(chatType: .counterpart, messageText: "우와", profileImageName: "image1", nickname: "오복이", sendTime: "오후 02:35"),
    MessageData(chatType: .counterpart, messageText: "우와 다들 너무 반가워요 !", profileImageName: "image1", nickname: "오복이", sendTime: "오후 02:35"),
