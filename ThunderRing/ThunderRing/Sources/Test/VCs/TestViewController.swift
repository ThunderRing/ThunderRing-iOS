...
final class TestViewController: UIViewController {
    ...
    private lazy var button = UIButton().then {
        ...
        $0.addTarget(self, action: #selector(pushToResult), for: .touchUpInside)
    }
    ...
    private func configUI() {
        ...
        view.addSubviews([customNavigationBar, indexLabel, button, progressView, contentScrollView])
    ...
    private func getNotification() {
        NotificationCenter.default.addObserver(self, selector: #selector(getSelectedAnswer), name: NSNotification.Name("SelectedAnswer"), object: nil)
    }
    
    
    // MARK: - @objc
    
    @objc func getSelectedAnswer(_ notification: Notification) {
